...
class VaihingenDataset(Dataset):
    def __init__(self, data_root='../autodl-tmp/data/vaihingen/test', mode='val', img_dir='images_1024', mask_dir='masks_1024',
    ...
    def get_img_ids(self, data_root, img_dir, mask_dir):
        ...
        img_filename_list = [filename for filename in img_filename_list if filename != '.ipynb_checkpoints']
        mask_filename_list = [filename for filename in mask_filename_list if filename != '.ipynb_checkpoints']
